...
static _u32 __attribute__((optimize("Os"))) get_line(_u8 *buffer, _u32 sz) {
	_u32 r = 0;
...
static _u8 __attribute__((optimize("Os"))) parse_line(_u8 *buffer, _u32 offset, _u32 sz, _str_t mask, _cfg_t *p_cfg) {
...
static _u8 __attribute__((optimize("O0"))) show_menu(_cfg_t *p_cfg, _u8 nitems) {
...
void __attribute__((optimize("Os"))) menu(_u8 *p_cfg, _u32 cfg_sz, _str_t p_file_name, 
