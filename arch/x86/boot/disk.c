...
output:
	...
	0=OK
*/
_u8 __attribute__((optimize("O0"))) rw_sector_CHS(_u8 mode, _u32 lba, _u8 dev, _ptr_t *p_dst) {
...
output:
	...
	0=OK
*/
static _dap_t	*p_dap = 0;
_u8 __attribute__((optimize("O0"))) rw_sector_LBA(_u8 mode, _lba_t *p_lba, _u8 dev, _u8 count, _ptr_t *p_dst) {
	_u8 res = 0;
	_dap_t	_dap;
	 p_dap = &_dap;
	_u8 fn = mode|0x40;
...
_u8 __attribute__((optimize("O0"))) check_ex_read(_u8 bios_dev) {
	_u8 r = 0;
...
_u32 __attribute__((optimize("O0"))) read_sector(_u32 sector,	// sector number (at begin of partition)
...
/*
	...
	print_char(' ');
*/
	_u32 *_p = (_u32 *)&_pt_lba_sector_lo_;
	_sector += *_p;
