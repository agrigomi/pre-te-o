...
#define MP_NEXT_RECORD(current_record) \
	(_mpc_record_t *)(((_u8 *)current_record) + current_record->size())

#define MP_VALID_RECORD(mpc_ptr, current_record) \
	(current_record->size() && ((_u8 *)current_record) < (((_u8 *)mpc_ptr) + mpc_ptr->len))
