...
#define PML4_4KPAGE2NUM(addr) ((_u64)addr >> 12)
#define PML4_2MPAGE2NUM(addr) ((_u64)addr >> 21)

// page number to physical address
#define PML4_4KNUM2PAGE(num)  ((_u64)num << 12)
#define PML4_2MNUM2PAGE(num)  ((_u64)num << 21)
