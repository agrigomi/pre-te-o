...
typedef struct _PCI_VENTABLE
{
	...
	const char *	VenShort ;
	const char *	VenFull ;
}__attribute__((packed))   PCI_VENTABLE, *PPCI_VENTABLE ;
...
typedef struct _PCI_DEVTABLE
{
	...
	const char *	Chip ;
	const char *	ChipDesc ;
}__attribute__((packed))   PCI_DEVTABLE, *PPCI_DEVTABLE ;
...
typedef struct _PCI_CLASSCODETABLE
{
	...
	const char *	SubDesc ;
	const char *	ProgDesc ;
}__attribute__((packed))   PCI_CLASSCODETABLE, *PPCI_CLASSCODETABLE ;
