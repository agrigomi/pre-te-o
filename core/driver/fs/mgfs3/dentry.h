...
bool mgfs_dentry_create(_mgfs_context_t *p_cxt, _h_inode_ hdir, _str_t name, // in
			_u32 sz_name, _u32 inode_number, _u8 flags, // in
			_h_dentry_ hd, // out
			_h_lock_ hlock=0
		       );

bool mgfs_dentry_rename(_mgfs_context_t *p_cxt, _h_inode_ hdir, _str_t name, _str_t new_name, _h_lock_ hlock=0);
bool mgfs_dentry_delete(_mgfs_context_t *p_cxt, _h_inode_ hdir, _str_t name, _h_lock_ hlock=0);
void mgfs_dentry_close(_mgfs_context_t *p_cxt, _h_dentry_ hd, _h_lock_ hlock=0);
void mgfs_dentry_list(_mgfs_context_t *p_cxt, _h_inode_ hdir, 
			_mgfs_dentry_list_t *p_callback, void *p_udata=0, _h_lock_ hlock=0);
