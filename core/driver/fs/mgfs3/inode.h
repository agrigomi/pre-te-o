...
_u32 mgfs_inode_delete(_mgfs_context_t *p_cxt, _h_inode_ hinode, _h_lock_ hlock=0);

_u32 mgfs_inode_owner(_h_inode_ hinode);

// append initialized blocks to inode, and return the number of new appended blocks
_u32 mgfs_inode_append_block(_mgfs_context_t *p_cxt, _h_inode_ hinode, _u32 nblocks, _u8 pattern, _h_lock_ hlock=0);
...
_h_buffer_ mgfs_inode_read_block(_mgfs_context_t *p_cxt, _h_inode_ hinode, _u32 block_number, _h_lock_ hlock=0);

// return the actual number of bytes
_u32 mgfs_inode_read(_mgfs_context_t *p_cxt, _h_inode_ hinode, _u64 offset, void *p_buffer, _u32 size, _h_lock_ hlock=0);
_u32 mgfs_inode_write(_mgfs_context_t *p_cxt, _h_inode_ hinode, _u64 offset, void *p_buffer, _u32 size, _h_lock_ hlock=0);

void mgfs_inode_close(_mgfs_context_t *p_cxt, _h_inode_ hinode, _h_lock_ hlock=0);
void mgfs_inode_update(_mgfs_context_t *p_cxt, _h_inode_ hinode, _h_lock_ hlock=0);

// truncate inode to size passed in 'new_size' parameter and return the new inode size
_u64 mgfs_inode_truncate(_mgfs_context_t *p_cxt, _h_inode_ hinode, _u64 new_size, _h_lock_ hlock=0);
